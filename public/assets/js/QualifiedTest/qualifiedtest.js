function register_qt() {
    ...
    send_data.append('other_edu_foreign', $("input[name=other_edu_foreign]").val());
...
function AddQTEdu() {
    ...
    $("#edu").append(
        ...
        `<div class="row">
                <div class="col-md-6">
                    <input type="text" name="edu_status_local[]" id="edu_status_local${count}" class="form-control" required>
                </div>
                <div class="col-md-6">
...
function selectEduForeign() {

    var value = $("input[name='edu_status_foreign']:checked").val();
