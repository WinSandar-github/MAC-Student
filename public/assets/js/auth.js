if (typeof (localStorage) != "undefined") {
    ...
    if (localStorage.getItem("studentinfo") == null) {
        ...
        let user = (student.accountancy_firm?.length != 0) ? student.accountancy_firm : (student.school)
            ? student.school : (student.mentor) ? student.mentor : (student.teacher) ? student.teacher : student

        var student_name = (student.accountancy_firm.length != 0 && student.accountancy_firm != NULL) ? user[0].accountancy_firm_name : user.name_eng;
