    ...
    $('#nrc_state_region').on('change', function(){
        ...
        nrc_townships.forEach(function(township){
            if(mmnrc_language === "mm"){
                ...
                '<li data-value="'+township.township_mm+'" class="option">'+
                township.township_mm+
                '</li>';
            } else {
                ...
                nrc_townships_options +=
                '<li data-value="'+township_en+'" class="option">'+
                township_en+
                '</li>';
            }
        });
        ...
        $("#nrc_township + .nice-select ul").html('');
        $("#nrc_township + .nice-select span").html('');
        $("#nrc_township + .nice-select span").append(currentSelect);
        $("#nrc_township + .nice-select ul").append(nrc_townships_options);
    });
    /**
