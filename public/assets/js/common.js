...
function addRowPartner(tbody) {
    ...
    cols += '<td><input type="text" name="foa_pub_pri_reg_no[]"  id="foa_pub_pri_reg_no' + row + '" onchange="checkPAPPExist(this.value,this.id,this,0)" class="form-control"  class="form-control" autocomplete="off"  /></td>';
...
function addRowPartnerOffline(tbody) {

    var newRow = $("<tr>");
    var cols = "";
    var row = $('.' + tbody + ' tr').length;
    cols += '<td align="center" class="align-middle">' + (row) + '</td>';
    cols += '<td><input type="text" name="foa_pub_pri_reg_no[]"  id="foa_pub_pri_reg_no' + row + '" onchange="checkPAPPExistOffline(this.value,this.id,this,1)" class="form-control"  class="form-control" autocomplete="off"  /></td>';
    cols += '<td><input type="text" name="foa_name[]" class="form-control" autocomplete="off"/></td>';
    cols += '<td><input type="radio" name="foa_authority_to_sign' + row + '" class="report_yes" value="1" > <label class="form-check-label" >Yes</label></td>';
    // cols += '<td>';
    // cols += '<div class="form-check pt-2">';
