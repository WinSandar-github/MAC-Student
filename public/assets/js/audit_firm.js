  ...
  $.ajax({
      ...
      success: function (data){
        console.log("get audit >>",data);
          ...
          if(audit_data.offline_user == 1 && audit_data.is_renew == 0 && audit_data.status == 1){
  ...
  $.ajax({
      ...
      success: function (data){
        console.log("get audit >>",data);
          ...
          if( audit_data.status == 2 && audit_data.offline_user == 1 ){
...
function auditInitialRejectUpdate(){
  var student =JSON.parse(localStorage.getItem("studentinfo"));
  var firm_id = student.accountancy_firm_info_id;
...
function auditRenewRejectUpdate(){
  var student =JSON.parse(localStorage.getItem("studentinfo"));
