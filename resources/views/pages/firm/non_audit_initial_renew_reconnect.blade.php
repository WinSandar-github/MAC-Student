                        ...
                        <div class="col-md-8">
                            <input type="text" name="registration_no"  class="form-control  @error('name') is-invalid @enderror" placeholder="Enter Registration No.!" autocomplete="off" value="{{ old('accountancy_firm_name') }}" >
								...
								<div class="row mb-3">
									...
									<div class="col-md-8">
											<textarea name="head_office_address_mm" id="head_office_address_mm" class="form-control" placeholder="Head Office Address(Myanmar)" autocomplete="off" value="" rows="3" style="resize:none;"></textarea>
									</div>
								</div>
