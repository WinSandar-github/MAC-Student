                        ...
                        <form method="post" id="da_two_reg_daone_pass_edit_form" action="javascript:void(0);" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="card border-success mb-3" style="padding:3% 5% 3% 5%;">
                                    ...
                                    <div class="row mb-3">
                                        <label class="col-md-8 col-form-label"><span class="pull-left" style="padding-right: 30px;">၂၀။</span>ဒီပလိုမာစာရင်းကိုင်(ပထမပိုင်း)သင်တန်း တက်ရောက်ခဲ့သူ/လျှောက်ထားခဲ့သူ</label>
                                    </div>
                                    ...
                                    <div class="row mb-3" >
                                        <label class="col-md-4 col-form-label label"><span class="pull-left" style="padding-left: 85px;">(ခ)</span>အောင်မြင်ခဲ့သည့် Module<span style="color:red">*</span></label>
                                    ...
                                    <div class="row mb-3">                                        
                                        <label class="col-md-4 col-form-label label"><span class="pull-left">၂၁။</span>သင်တန်းတက်ရောက်မည့်နေရာ<span style="color:red">*</span></label>
                                        <div class="col-sm-8 col-md-8 checkbox-radios   py-2">
                                            <div class="form-check-radio px-0">
            ...
            if (localStorage.getItem("studentinfo") != null)
            {
                get_student_info(student_id).then(data => {
                    if(data){
                        ...
                        info.student_course_regs.forEach(function(element){
                            if(element.batch.id!=batch_id){
                                if(element.type == 0){
                            ...
                            else if(element.batch.id==batch_id){
                                if(element.type == 0){
                        ...
                        $('#selected_passed_batch_id').val(last_exam[0].batch_id);
