                            ...
                            <form method="post" action="javascript:void(0);" id="da_mac_form"
                                ...
                                <div class="card border-success mb-3 p-5">
                                    ...
                                    <h5 class="card-title text-center">
                                        ဒီပလိုမာစာရင်းကိုင်(ပထမပိုင်း)သင်တန်းတက်ရောက်ခွင့်နှင့်
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <h6>{{ __('အမှတ်စဉ် - Batch One') }}</h6>
                                        <h6>{{ __('ပညာသင်နှစ် - 2021') }}</h6>
                                    </div>
                                            ...
                                            {{--<table style="width:100%;margin-bottom: 2%;">
                                                <tr>
                                                    ...
                                                    <td style="float: right;">
                                                        <label for=""
                                                               class="col-form-label">{{ __('ပညာသင်နှစ် - 2021') }}</label>
                                                    </td>
                                                </tr>
                                            </table>--}}
...
@endforeach
                                                    ...
                                                    <div class="row">
                                                        <label for=""
                                                               class="col-md-1 col-form-label">{{ __('၃။') }}</label>
                                            ...
                                            <div class="row">
                                                ...
                                                <label for=""
                                                       class="col-md-3 col-form-label label_align_right">လူမျိုး</label>
                                                <div class="col-md-8">
                                            ...
                                            <div class="row">
                                                ...
                                                <label for=""
                                                       class="col-md-3 col-form-label label_align_right">ရာထူး</label>
                                                <div class="col-md-8">
                                            ...
                                            <div class="row">
                                                ...
                                                <label for=""
                                                       class="col-md-3 col-form-label label_align_right">ဌာန</label>
                                                <div class="col-md-8">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-1 col-form-label"><input type="checkbox"
                                                                                            name="submit_confirm"
                                                                                            id="submit_confirm_mac"
                                                                                            onclick="ConfirmSubmitMac()">
                                                </div>
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-2 offset-md-5">
                                                    <button type="submit" class="btn btn-success btn-hover-dark w-100"
                                                            id="submit_btn_mac">{{ __('Submit') }}</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <form method="post" action="javascript:void(0);" id="da_private_school_form"
                                ...
                                <div class="card border-success mb-3">
                                    ...
                                    <h5 class="card-title text-center my-1">
                                        ဒီပလိုမာစာရင်းကိုင်(ပထမပိုင်း)သင်တန်းတက်ရောက်ခွင့်နှင့်
                                        မှတ်ပုံတင်ခွင့်လျှောက်လွှာ</h5>
                                    <h5 class="card-title text-center my-1">(ကိုယ်ပိုင်သင်တန်းကျောင်းတွင် တက်ရောက်မည့်
                                        အသစ်တက်ခွင့်ရသူများ)</h5><br/><br/>
                                    <div class="card-body">
                                        <div class="col-md-12">
                                            <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="row">
                                                        <label for=""
                                                               class="col-md-1 col-form-label">{{ __('၁။') }}</label>
                                                        <label for="" class="col-md-5 col-form-label label_align_right">အမည်(မြန်မာ/အင်္ဂလိပ်)</label>
                                                        <div class="col-md-3">
                                                    ...
                                                    <div class="row">
                                                        <label for=""
                                                               class="col-md-1 col-form-label">{{ __('၂။') }}</label>
                                                        <label for="" class="col-md-5 col-form-label label_align_right">နိုင်ငံသားစိစစ်ရေးကတ်ပြားအမှတ်</label>
                                                        <div class="col-md-6">
                                                            <div class="row" style="padding-top: 0px; margin-top: 0px;">
                                                                <div class="col-md-2 col-5 pr-1">
...
@endforeach
                                            ...
                                            <div class="row mb-3">
                                                <label class="col-md-4 col-form-label label_align_right">(၁)
                                                    တိုက်ရိုက်တက်ရောက်ခွင့်ရသည့်အမှတ်စဥ်</label>
                                        ...
                                        <!-- <div class="row">
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" name="part_no_self"
                                                           class="form-control course_name" disabled
                                                           placeholder="အပိုင်း" id="" required>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-8">
                                                    <input type="text" name="personal_no_self" class="form-control"
                                                           placeholder="ကိုယ်ပိုင်အမှတ်" id="">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <label class="col-md-3 col-form-label label_align_right">နောက်ဆုံးဖြေဆိုခဲ့သည့်စာမေးပွဲကျင်းပသည့်
                                                    ခုနှစ်/လ</label>
                                                <div class="col-md-8">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-2 offset-md-5">
                                                    <button type="submit" class="btn btn-success btn-hover-dark w-100"
                                                            id="submit_btn_ss">{{ __('Submit') }}</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
