                            ...
                            <div class="row">
                                <div class="card border-success mb-3" style="padding:3% 5% 3% 5%;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-9">
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-md-7" style="padding-left:35px;">
                                                    <input type="password" placeholder="လျှို့ဝှက်နံပါတ်ကို နောက်တစ်ကြိမ်ထပ်မံထည့်ပါ။" name="confirm_password" class="form-control" id="confirm_password" minlength="8">
                                                </div>
                                            </div>
                                        </div>
                                 ...
                                 {{--   <div class="row">
                                    ...
                                    <div class="row mb-3">
                                        <label class="col-md-4 col-form-label label"><span class="pull-left">၂၃။</span>သင်တန်းတက်ရောက်မည့်နေရာ<span style="color:red">*</span>-</label>
