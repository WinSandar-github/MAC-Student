                        ...
                        <div class="card-body">
                            <form id="school_register_form" enctype="multipart/form-data" action="javascript:createSchoolRegister();" class="needs-validation" autocomplete="off" novalidate>
                                ...
                                <div class="row">
                                    <div class="col-md-8">
                                        <div class="row">
                                            ...
                                            <label class="col-md-5 col-form-label label_align_right">{{ __('အီးမေးလ်') }}</label>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row">
                                            ...
                                            <label class="col-md-5 col-form-label label_align_right">{{ __('လျို့ဝှက်နံပါတ်') }}</label>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            ...
                                            <label class="col-md-5 col-form-label label_align_right">{{ __('လျို့ဝှက်နံပါတ် အတည်ပြုခြင်း') }}</label>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                ...
                                <div class="row">
                                  ...
                                  <label class="col-md-3 col-form-label label_align_right">{{ __('အမည်(မြန်မာ/အင်္ဂလိပ်)') }}</label>
                                  <div class="col-md-4">
                                      <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <label class="col-md-3 col-form-label label_align_right">{{ __('နိုင်ငံသားစိစစ်ရေးကတ်ပြားအမှတ်') }}</label>
                                    <div class="col-md-8">
                                        <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <label class="col-md-3 col-form-label">{{ __('မွေးသက္ကရာဇ်') }}</label>
                                    <div class="col-md-8">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <label class="col-md-3 col-form-label">{{ __('ဖုန်းနံပါတ်') }}</label>
                                    <div class="col-md-8">
                                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <label class="col-md-3 col-form-label">{{ __('အဆောက်အဦအခင်းအကျင်းများအားရယူသုံးစွဲပုံ') }}</label>
                                <div class="col-md-7">
                                    <div class="form-group">
                                    <div class="form-check mt-2 form-check-inline">
                            ...
                            <div class="row">
                                <label class="col-md-1 col-form-label">{{ __('') }}</label>
                                <label class="col-md-1 col-form-label">{{ __('') }}</label>
                                <label class="col-md-3 col-form-label">{{ __('သက်ဆိုင်သည့်အထောက်အထားများ၊စာချုပ်စာတမ်းများ') }}</label>
                                <div class="col-md-6">
                                <div class="mb-3 col-auto">
                            ...
                            <div class="row">
                                <label class="col-md-1 col-form-label"></label>
                                <label class="col-md-10 col-form-label"><b>{{ __('ကျောင်းတည်ရာလိပ်စာ၊ကျောင်းအဆောက်အဦ၊စာသင်ခန်း၊သန့်စင်ခန်း၊စီမံရုံးခန်း') }}</b></label>
                            </div>

                            <div class="row">
                                <label class="col-md-1 col-form-label">{{ __('၁။') }}</label>
                                <label class="col-md-2 col-form-label">{{ __('ကျောင်းတည်ရာလိပ်စာ') }}</label>
                                <div class="col-md-8">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <label class="col-md-1 col-form-label">{{ __('') }}</label>
                                <label class="col-md-2 col-form-label">{{ __('ကျောင်းခွဲတည်ရာလိပ်စာ') }}</label>
                                <div class="col-md-8">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <label class="col-md-1 col-form-label">{{ __('၂။') }}</label>
                                <label class="col-md-10 col-form-label">{{ __('ကျောင်းအဆောက်အဦ(အဆောက်အဦအမျိုးအစား/အတိုင်းအတာ/အထပ်အရေအတွက်)') }}</label>
                            </div>
                            <div class="row">
                                <label class="col-md-1 col-form-label">{{ __('') }}</label>
                                <label class="col-md-2 col-form-label">{{ __('အဆောက်အဦအမျိုးအစား') }}</label>
                                <div class="col-md-8">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <label class="col-md-1 col-form-label">{{ __('') }}</label>
                                <label class="col-md-2 col-form-label">{{ __('အတိုင်းအတာ') }}</label>
                                <div class="col-md-8">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <label class="col-md-1 col-form-label">{{ __('') }}</label>
                                <label class="col-md-2 col-form-label">{{ __('အထပ်အရေအတွက်') }}</label>
                                <div class="col-md-8">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <label class="col-md-1 col-form-label">{{ __('') }}</label>
                                <label class="col-md-2 col-form-label">{{ __('အခန်းအရေအတွက်') }}</label>
                                <div class="col-md-8">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <label class="col-md-1 col-form-label">{{ __('') }}</label>
                                <label class="col-md-2 col-form-label">{{ __('ဝင်ဆံ့သင်တန်းသား') }}</label>
                                <div class="col-md-8">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <label class="col-md-1 col-form-label">{{ __('') }}</label>
                                <label class="col-md-2 col-form-label">{{ __('လေအေးပေးစက်') }}</label>
                                <div class="col-md-8">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <label class="col-md-1 col-form-label">{{ __('') }}</label>
                                <label class="col-md-2 col-form-label">{{ __('အမျိုးအစား') }}</label>
                                <div class="col-md-8">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <label class="col-md-1 col-form-label">{{ __('') }}</label>
                                <label class="col-md-2 col-form-label">{{ __('အရေအတွက်') }}</label>
                                <div class="col-md-8">
                                    <div class="form-group">
