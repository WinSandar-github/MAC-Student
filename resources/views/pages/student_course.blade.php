...
@section('content')
                    ...
                    <h2 class="title">
                        {{
                            ...
                            /*request()->segment(count(request()->segments())) == 1
                                ...
                                : (request()->segment(count(request()->segments() == 2)) ? "Certified Public Accountant" : 'QT')*/
                        }}
                        <p class="col-md-5">Information </p>
                    </h2>
                </div>
                <!-- Page Banner End -->
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="info-list">
                                                        <dl class="row d_font ">
                                                            ...
                                                            <dt class="col-sm-6 text-end my-1">Exam Registration Fee</dt>
                                                            <dd class="col-sm-6 my-1">{{  number_format($c['exam_fee'] ) }}
                                                                Kyats
                                                            </dd>
                                                            <dt class="col-sm-6 text-end my-1">Entry Exam Registration Fee</dt>
                                                            <dd class="col-sm-6 my-1">{{  number_format($c['entry_exam_fee'] ) }}
                                                                Kyats
                                                            </dd>
    ...
    <div class="modal fade" id="entryClassModel" tabindex="-1" aria-labelledby="exampleModalLabe" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h3 class="modal-title text-center" style="font-weight:bold">
                        သင်တန်းတက်ရောက်ခွင့်ပုံစံ ရွေးချယ်ပါ
                    </h3>
                ...
                <div class="modal-body text-center">
                    <p class="text-start">
                        ...
                        ဘွဲ့တစ်ခုခုရရှိပြီး ACCA Fundamental Skills Level ပြီးစီးသူများ နှင့်
                        CIMA Diploma in Management Accounting ပြီးစီးသူများ</p>
                    <a id="dir_cpa" href="" class="btn btn-md btn-success">Direct</a>
                    <hr>
