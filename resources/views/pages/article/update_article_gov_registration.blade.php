                                ...
                                <div class="row">
                                    <div class="card border-success mb-3" style="padding:3% 5% 3% 5%;">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="home_address" name="home_address" class="form-control" placeholder="ဇာတိမြို့နယ်">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="current_address" name="current_address" class="form-control" placeholder="ကြီးပြင်းရာမြို့နယ်">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3" style="margin-left: 100px">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="tempory_address" name="tempory_address" class="form-control" placeholder="ခေတ္တ">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3" style="margin-left: 100px">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" id="permanent_address" name="permanent_address" class="form-control" placeholder="အမြဲတမ်း">
                                            </div>
                                        </div>
