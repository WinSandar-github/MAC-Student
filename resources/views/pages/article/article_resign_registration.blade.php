            ...
            <div class="blog-details-comment">
                    <div class="comment-form">
                        ...
                        <div class="reject_article" style="display:none;">
                            ...
                            <form method="post" id="article_reject_form"  action="javascript:updateResignArticle();"
                                    enctype="multipart/form-data" novalidate>
                                @csrf
                                <!-- <input type="hidden" id="offline_user"> -->
                                <div class="row">
                                    <div class="card border-success mb-3" style="padding:3% 5% 3% 5%;">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="row mb-5">
                                                    ...
                                                    <div class="col-md-8">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <input type="text" placeholder="အမည်(မြန်မာ)" name="update_name_mm" id="name_mm" class="form-control" value="{{ old('name_mm') }}" readonly >
                                                            </div>
                                                            <div class="col-md-6">
                                                                <input type="text" placeholder="အမည်(အင်္ဂလိပ်)" name="update_name_eng" id="name_eng" class="form-control" value="{{ old('name_eng') }}" readonly>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-4 text-center">
                                                ...
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                    ...
                                                    <div class="d-flex justify-content-center">
                                                        ...
                                                        <input type="file" id="profile_photo" name="update_profile_photo" accept="image/*"></span>
                                                        <br>
                                                        <a href="javascript:;" class="btn btn-danger btn-round fileinput-exists" data-dismiss="fileinput"><i class="fa fa-times"></i> Remove</a>
                                                    </div>
                                                </div>
                                                ...
                                                <table class="table tbl_degree table-bordered input-table">
                                                    <thead>
                                                        <tr >
                                                            ...
                                                            <th class="less-font-weight text-center"  width="40%">တက္ကသိုလ်/ဘွဲ့/ဒီပလိုမာ</th>
                                                            <th class="less-font-weight text-center"  width="40%">Attached Certificate</th>
                                                            <th class="text-center" width="10%"><button type="button" class="btn btn-success btn-sm btn-plus" onclick='addRowEducation("tbl_degree")' disabled><li class="fa fa-plus"></li></button></th>
                                                        </tr>
                                                    </thead>
                                                    <tbody class="tbl_degree_body">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <div class="row">
                                                <div class="col-md-6">
                                                    <input type="text" placeholder="လူမျိုး" name="update_race" id="update_race" class="form-control" value="{{ old('race') }}" readonly>
                                                </div>
                                                <div class="col-md-6">
                                                    <input type="text" placeholder="ကိုးကွယ်သည့်ဘာသာ" name="update_religion" id="update_religion" class="form-control" value="{{ old('religion') }}" readonly >
                                                </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-md-3 col-form-label label"><span class="pull-left">{{ __('၆။') }}</span>မွေးသက္ကရာဇ်</label>
                                            <div class="col-md-9">
                                                <input type="text" name="update_date_of_birth" id="update_date_of_birth" class="form-control" placeholder="ရက်၊လ၊နှစ်(DD-MMM-YYYY)" value="{{ old('date_of_birth') }}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-md-3 col-form-label label"><span class="pull-left">{{ __('၇။') }}</span>နုတ်ထွက်လိုသည့်နေ့<span style="color:red">*</span></label>
                                            <div class="col-md-9">
                                                <input type="text" placeholder="ရက်၊လ၊နှစ်(DD-MMM-YYYY)" name="update_resign_date" id="update_resign_date" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-md-3 col-form-label label"><span class="pull-left">{{ __('၈။') }}</span>နုတ်ထွက်ရသည့်အကြောင်းအရင်း<span style="color:red">*</span></label>
                                            <div class="col-md-9">
                                                <textarea placeholder="နုတ်ထွက်ရသည့်အကြောင်းအရင်း" name="update_resign_reason" id="update_resign_reason" class="form-control" rows="3" style="resize:none;"></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-md-3 col-form-label label"><span class="pull-left" id="address_label">{{ __('၉။') }}</span>ဆက်သွယ်ရန်လိပ်စာ<span style="color:red">*</span></label>
                                            <div class="col-md-9">
                                                <input type="text" placeholder="ဆက်သွယ်ရန်လိပ်စာ" name="update_address" id="update_address" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-md-3 col-form-label label"><span class="pull-left" id="m_email_label">{{ __('၁၀။') }}</span>အီးမေးလ်လိပ်စာ<span style="color:red">*</span></label>
                                            <div class="col-md-9">
                                                <input type="email" placeholder="အီးမေးလ်လိပ်စာ" name="update_m_email" id="update_m_email" class="form-control" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-md-3 col-form-label label"><span class="pull-left" id="phone_label">{{ __('၁၁။') }}</span>ဖုန်းနံပါတ်<span style="color:red">*</span></label>
                                            <div class="col-md-9">
                                                <input type="text" name="update_phone_no" id="update_phone_no" class="form-control" placeholder="ဖုန်းနံပါတ်">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-md-3 col-form-label label"><span class="pull-left">{{ __('၁၂။') }}</span>အလုပ်သင်ဆင်းသည့်ဌာနအဖွဲ့အစည်း(သို့မဟုတ်)Firm<span style="color:red">*</span></label>
                                            <div class="col-md-9">
                                                <input type="text" name="update_recent_org" id="update_recent_org" class="form-control" placeholder="အလုပ်သင်ဆင်းသည့်ဌာနအဖွဲ့အစည်း(သို့မဟုတ်)Firm">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-md-3 col-form-label label"><span class="pull-left">{{ __('') }}</span>Firm တွင် အလုပ်သင်ဆင်းနေသူဖြစ်ပါက သက်ဆိုင်ရာ PAPP ၏နုတ်ထွက်ခွင့်ပြုသည့် အကြောင်းကြားစာပူးတွဲတင်ပြရန်</label>
                                            <div class="col-md-9">
                                                <input type="file" name="update_resign_approve_attach"  class="form-control">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <label class="col-md-3 col-form-label"></label>
                                            <div class="col-md-9 resign_approve_file">
                                                <input type="hidden" id="hresign_approve_attach" >
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <div class="form-check">
                                                <label class="form-check-label">
                                                    <input class="form-check-input" type="checkbox" name="know_policy_rej" onchange="validateSubmitClick()">
                                                    <span class="form-check-sign"></span>
                                                    <p class="fw-bolder">
                                                        * အလုပ်သင်သက်တမ်းတစ်လျောက်တွင် တစ်ကြိမ်သာ နုတ်ထွက်ခွင့်ရှိပြီး အလုပ်သင်ပြန်လည်ဆင်းမည်ဆိုပါက နုတ်ထွက်ခွင့်ပြုသည့်နေ့မှစ၍ အနည်းဆုံးတစ်နှစ်ကြာမှသာ ပြန်လည်ဆင်းခွင့်ရှိမည်ဖြစ်ကြောင်း သိရှိပြီးဖြစ်ပါသည်။<br>
                                                    </p>
                                        ...
                                        <div class="row justify-content-center">
                                            <button type="submit" id="submit_btn_rej" class="btn btn-success btn-hover-dark w-25" disabled>
                                                Submit
                                            </button>
                                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function (e) {
        ...
        $("input[name='update_resign_date']").flatpickr({
                enableTime: false,
                dateFormat: "d-M-Y",
                allowInput: true
        });
    ...
    function validateSubmitClick(){
      ...
      var check_know_policy_rej = $("input[name=know_policy_rej]").prop('checked');
      ...
      if(check_know_policy_rej == true && check_confirm_142_rej == true && check_mentor_declare_rej == true){
        $("#submit_btn_rej").prop('disabled',false);
      }
      else if(check_know_policy_rej == false || check_confirm_142_rej == false || check_mentor_declare_rej == false){
        $("#submit_btn_rej").prop('disabled',true);
      }
    }
