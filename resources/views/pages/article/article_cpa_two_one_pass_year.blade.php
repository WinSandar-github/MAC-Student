                            ...
                            <form method="post" id="article_cpaTwoPassOneYear_form"  action="javascript:void();"
                                ...
                                <div class="row">
                                    <div class="card border-success mb-3" style="padding:3% 5% 3% 5%;">
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-md-6 col-form-label label"><span class="pull-left">အကြောင်းအရာ။</span>လက်တွေ့အလုပ်သင်(၁)နှစ်ထပ်မံဆင်းရန် ဆန္ဒပြုခြင်း</label>
                                        </div>
                                        ...
                                        <div class="row mb-5">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <input type="text" placeholder="အမည်(မြန်မာ)" name="name_mm" id="name_mm" class="form-control"  >
                                                            </div>
                                                            <div class="col-md-6">
                                                                <input type="text" placeholder="အမည်(အင်္ဂလိပ်)" name="name_eng" id="name_eng" class="form-control"  >
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div id="previous_papp_name_row" >
                                            <div class="row mb-3">
                                                <label class="col-md-3 col-form-label label"><span class="pull-left">{{ __('၁၅။') }}</span>ယခင်အလုပ်သင်ကြားခဲ့သည့် PAPP အမှတ်</label>
                                                <div class="col-md-9">
                                    ...
                                    <div class="card border-success mb-3" style="padding:3% 5% 3% 5%;">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="row mb-5">
                                                    <label class="col-md-4 col-form-label label"><span class="pull-left">{{ __('၁။') }}</span>အီးမေးလ်</label>
                                                    <div class="col-md-8">
                                                        <input type="email" placeholder="အီးမေးလ်လိပ်စာထည့်ပါ" name="update_email" class="form-control" id="email">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-5 exist_pass">
                                                    <label class="col-md-4 col-form-label label "><span class="pull-left ">{{ __('၂။') }}</span>လျို့ဝှက်နံပါတ်</label>
                                                    <div class="col-md-8">
                                                        <input type="password" placeholder="လျို့ဝှက်နံပါတ်ထည့်ပါ" name="update_password" class="form-control" id="password" minlength="8">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-5 exist_confirm_pass">
                                                    <label class="col-md-4 col-form-label label "><span class="pull-left">{{ __('၃။') }}</span>လျို့ဝှက်နံပါတ်အတည်ပြုခြင်း</label>
                                                    <div class="col-md-8">
                                                        <input type="password" placeholder="လျို့ဝှက်နံပါတ်အတည်ပြုခြင်း" name="update_confirm_password" class="form-control" id="confirm_password" required>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row mb-5">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <input type="text" placeholder="အမည်(မြန်မာ)" name="update_name_mm" id="name_mm" class="form-control"  >
                                                            </div>
                                                            <div class="col-md-6">
                                                                <input type="text" placeholder="အမည်(အင်္ဂလိပ်)" name="update_name_eng" id="name_eng" class="form-control"  >
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="fileinput fileinput-new text-center mt-4" data-provides="fileinput">
                                                    ...
                                                    <div>
                                                        <span class="btn btn-secondary btn-round btn-file">
                                                            ...
                                                            <input type="file" id="nrc_front" name="update_nrc_front" value="{{ old('nrc_front') }}" accept="image/*">
                                                        </span>
                                                        <a href="javascript:;" class="btn btn-danger btn-round fileinput-exists" data-dismiss="fileinput"><i class="fa fa-times"></i> Remove</a>
                                                    </div>
                                                    <span class="form-text text-danger">Allowed Jpeg and Png Image.</span>
                                                ...
                                                <div class="fileinput fileinput-new text-center mt-4" data-provides="fileinput">
                                                    ...
                                                    <div>
                                                            <span class="btn btn-secondary btn-round btn-file">
                                                                <span class="fileinput-new">နိုင်ငံသားစိစစ်ရေးကတ်ပြား(အနောက်)</span>
                                                                <span class="fileinput-exists">Change</span>
                                                                <input type="hidden" id="hnrc_back"><input type="file" id="nrc_back" name="update_nrc_back" value="{{ old('nrc_back') }}" accept="image/*">
                                                            </span>
                                                        <a href="javascript:;" class="btn btn-danger btn-round fileinput-exists" data-dismiss="fileinput"><i class="fa fa-times"></i> Remove</a>
                                                    </div>
                                                    <span class="form-text text-danger">Allowed Jpeg and Png Image.</span>
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-md-3 col-form-label label"><span class="pull-left" id="current_address_label">{{ __('၁၂။') }}</span>ဆက်သွယ်ရန်လိပ်စာ<span style="color:red">*</span></label>
                                            <div class="col-md-9">
                                                <input type="text" placeholder="ဆက်သွယ်ရန်လိပ်စာ" name="update_current_address"  class="form-control" id="update_current_address">
                                            </div>
                                        </div>
                                        ...
                                        <div id="previous_papp_name_row" >
                                            <div class="row mb-3">
                                                <label class="col-md-3 col-form-label label"><span class="pull-left">{{ __('၁၅။') }}</span>ယခင်အလုပ်သင်ကြားခဲ့သည့် PAPP အမှတ်</label>
                                                <div class="col-md-9">
                                                    <input type="text" name="update_previous_papp_name" id="update_previous_papp_name" class="form-control" placeholder="ယခင်အလုပ်သင်ကြားခဲ့သည့်PAPPအမှတ်(eg.PA-123)">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="previous_papp_date_row" >
                                            <div class="row mb-3">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <input type="text" placeholder="dd-mm-yyyy" name="update_previous_papp_start_date" id="update_previous_papp_start_date" class="form-control" >
                                                    </div>
                                                    <div class="col-md-6">
                                                        <input type="text" placeholder="dd-mm-yyyy" name="update_previous_papp_end_date" id="update_previous_papp_end_date" class="form-control" >
                                                    </div>
                                                    </div>
                                                </div>
                                            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function (e) {
        ...
        $("input[name='pass_month']").flatpickr({
                enableTime: false,
                dateFormat: "M",
                allowInput: true
        });
        $("input[name='pass_year']").flatpickr({
                enableTime: false,
                dateFormat: "Y",
                allowInput: true
        });
