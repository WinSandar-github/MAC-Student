                                    ...
                                    <div class="card border-success mb-3" style="padding:3% 5% 3% 5%;">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-11">
                                                    <ul>
                                                        ...
                                                        <li>သည် မြန်မာနိုင်ငံစာရင်းကောင်စီက ဖွင့်လှစ်သည့် လက်မှတ်ရပြည်သူ့စာရင်းကိုင်
                                                            <li>
                                                                <input type="radio" class="form-check-input" value="( ဒုတိယပိုင်း ) သင်တန်း"  name="update_course_exam" >
                                                                <label class="form-check-label " for=""> ( ဒုတိယပိုင်း ) သင်တန်း/</label><br/>
                                                                <input type="radio" class="form-check-input" value="အရည်အချင်းစစ်စာမေးပွဲ"  name="update_course_exam" >
                                                                <label class="form-check-label " for="">အရည်အချင်းစစ်စာမေးပွဲ</label>
                                                            </li>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                ...
                                                <div class="row mb-5">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="password" placeholder="လျို့ဝှက်နံပါတ်အတည်ပြုခြင်း" name="update_confirm_password" class="form-control" id="confirm_password">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row mb-5">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <input type="text" placeholder="အမည်(မြန်မာ)" name="update_name_mm" id="name_mm" class="form-control" value="{{ old('name_mm') }}" >
                                                            </div>
                                                            <div class="col-md-6">
                                                                <input type="text" placeholder="အမည်(အင်္ဂလိပ်)" name="update_name_eng" id="name_eng" class="form-control" value="{{ old('name_eng') }}" >
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-check">
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                <input type="radio" class="form-check-input mr-3" value="1" id="experience_yes" name="update_experience" >
                                                                <label class="form-check-label " for="">ရှိ</label>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <input type="radio" class="form-check-input mr-3" value="0" id="experience_no" name="update_experience" >
                                                                <label class="form-check-label " for="">မရှိ</label>
                                                            </div>
                                                            <label  class="error attend_place_error" style="display:none;" for="experience">Please select one</label>
                                                        </div>
                                        ...
                                        <div id="exp_attach_row" style="display:none">
                                            <div class="row mb-3">
                                                <label class="col-md-3 col-form-label label"><span class="pull-left">{{ __('') }}</span>ရှိပါက အထောက်အထားများဖြင့် တင်ပြပေးပါရန်</label>
                                                <div class="col-md-9" id="experience">
                                                    <div class="row mb-3" id="experience0">
                                                        <div class="col-md-11" id="exp_file">
                                                            <input type="file" class="form-control" id="update_experience_file0" name="update_experience_file[]" autocomplete="off">
                                                        </div>
                                                        <div class="col-md-1 text-center" id="add_div">
                                                            <button type="button" class="btn btn-primary" id="add_btn" onclick="AddExp()">
                                                                <i class="fa fa-plus"></i>
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-9 exp_attachment">
                                                    <input type="hidden" id="hexp_attach">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-9">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <input id="update_papp_name" type="text" name="update_papp_name" class="form-control" placeholder="လက်တွေ့အလုပ်သင်ကြားလိုသည့် PAPP အမှတ်">
                                                    </div>
                                                    <div class="col-md-6">
                                        ...
                                        <div id="previous_exam_pass_row" >
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <input type="text" placeholder="dd-mm-yyyy" name="pass_date" id="update_pass_date" class="form-control" >
                                                        </div>
                                                        <div class="col-md-6">
                                                            <input type="text" placeholder="အောင်မြင်သည့်အမှတ်စဥ်" name="update_pass_no" id="pass_no" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
