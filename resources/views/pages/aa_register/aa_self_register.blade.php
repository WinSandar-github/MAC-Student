...
@section('content')
    <div class="main-wrapper">
            ...
            <div class="blog-details-comment">
                ...
                <!-- Form Wrapper Start -->
                    <div class="form-wrapper">
                        <form method="post" action="javascript:void();" id="aa_self_form" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="card border-success mb-3" style="padding:3% 5% 3% 5%;">
                                  <div class="row">
                                    <div class="col-md-8">
                                      ...
                                      <div class="row">
                                          <label for="" class="col-md-1 col-form-label">{{ __('') }}</label>
                                          <label for="" class="col-md-5 col-form-label label_align_right">Recommend Letter (jpg,pdf)</label>
                                          <div class="col-md-6">
                                            <div class="form-group">
                                  ...
                                  <div class="row">
                                      ...
                                      <label for="" class="col-md-3 col-form-label v">ကိုးကွယ်သည့်ဘာသာ</label>
                                      <div class="col-md-8">
                                  ...
                                  <br>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-3 offset-md-5">
                                            <button type="submit" class="btn btn-success btn-hover-dark w-100" id="self_submit">{{ __('Submit') }}</button>
                                        </div>
                                    </div>
        ...
        <!-- Modal Payment -->
<form method="post" class="needs-validation" action="javascript:createAASelfRegister();" enctype="multipart/form-data" novalidate>
    @csrf
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row justify-content-center">
                        <center>
                            <h4 style="margin-bottom:5%;">AA (Self Study) Form Fee - ****** MMK</h4>
                        </center>
                        ...
                        <center>
                            <button type="submit" id="aa_self_btn" class="btn btn-success btn-hover-dark w-30" data-bs-toggle="modal">Pay Now </button>
                        </center>
                    </div>
                </div>
                <br>
...
<script>
    ...
    $('#cash_img_self').click(function() {
        $('#aa_self_btn').prop('disabled', false);
    });

    $('#aa_self_btn').prop('disabled', true);
</script>
@endpush
