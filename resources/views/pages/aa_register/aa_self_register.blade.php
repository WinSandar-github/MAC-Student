                                ...
                                <div class="card border-success mb-3" style="padding:3% 5% 3% 5%;">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-3 offset-md-5">
                                            <button type="submit" class="btn btn-success btn-hover-dark w-100"  data-bs-toggle="modal" data-bs-target="#paymentSSModal">{{ __('Submit') }}</button>
                                        </div>
                                    </div>
...
<form method="post" class="needs-validation" action="javascript:createAASelfRegister();" enctype="multipart/form-data" novalidate>
    @csrf
    <div class="modal fade" id="paymentSSModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
