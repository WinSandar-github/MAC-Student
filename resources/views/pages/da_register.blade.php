                            ...
                            <div class="row">
                                ...
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td width="75%">
                                            <div class="single-form">
                                                <input type="file" id="image" placeholder="upload photo" name="image" value="{{ old('image') }}" required="" style="padding: 2%;">
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                                ...
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td width="75%">
                                            <div class="single-form">
                                                <input type="file" id="certificate" placeholder="upload photo" name="certificate" value="{{ old('document') }}" required="" style="padding: 2%;">
                                            </div>
                                        </td>
                                    </tr>
                                </table>
