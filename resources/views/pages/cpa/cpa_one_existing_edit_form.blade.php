            ...
            <div class="blog-details-comment">
                <div class="comment-form">
                    ...
                    <div class="form-wrapper">
                        ...
                        <form method="post" id="existing_user_cpa_one_edit_form" action="javascript:void(0);" enctype="multipart/form-data">
                            @csrf                                                                            
                                ...
                                <div class="card border-success mb-3" style="padding:3% 5% 3% 5%;">
                                    ...
                                    <div class="row mb-5">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <h6>အမှတ်စဉ် - <span id="batch_number"></span></h6>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" placeholder="ဖုန်းနံပါတ်" name="phone" class="form-control" value="" required="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        <label class="col-md-8 col-form-label"><span class="pull-left" style="padding-right: 30px;">၂၀။</span>လက်မှတ်ရပြည်သူ့စာရင်းကိုင်(ပထမပိုင်း)သင်တန်း တက်ရောက်ခဲ့သူ/လျှောက်ထားခဲ့သူ</label>
                                    </div>
...
@push('scripts')
    ...
    <script type="text/javascript">
        ...
        $(window).bind('pageshow', function (){
            $("#existing_user_cpa_one_edit_form").get(0).reset();
        });
        ...
        $(document).ready(function (e) {
            ...
            if (localStorage.getItem("studentinfo") != null)
            {
                get_student_info(student_id).then(data => {
                    if(data){
                        var info = data.data;
                        var student_course_regs = info.student_course_regs;
                        ...
                        if(student_course_regs[0].type == 0){
                            ...
                            selectType();
                            if(student_course_regs[0].mac_type == 1){
                        ...
                        $('#sr_no').val(student_course[0].sr_no);
                        $('#selected_passed_batch_id').val(student_course_regs[0].batch_id);
                        ...
                        if(info.student_course_regs.length == 2 && info.student_course_regs[0].qt_entry == 1){
                            ...
                            $("input[name=entry_success_no]").val(last_exam[0].sr_no);
                            $("input[name=entry_success_roll_no]").val(student_course[0].sr_no);
