     ...
     <div class="main-wrapper">
        ...
        <div class="section"> <!-- section-padding mt-n10 -->
            ...
            <div class="card border-success mb-3" id="cpaff_renew_form"><br/><!---->
                ...
                <form method="post" enctype="multipart/form-data"  id="cpaff_renew_form_submit" action="javascript:RenewOfflineCPAFF()">
                    @csrf
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="row mb-3" style="padding-left: 110px;">
                                ...
                                <div class="row mb-3" style="padding-left: 110px;">
                                    <div class="col-md-3 col-form-label label"><span class="pull-left">{{ __('(ဆ)') }}</span>{{ __('CPA(Full-Fledged) Registeration No.') }}</div>
                                    <div class="col-md-8">
                                        <input type="text"  class="form-control" name="cpaff_reg_no" id="cpaff_reg_no">
                                    </div>
                                </div>
                                <div class="row mb-3" style="padding-left: 110px;">
                                    <div class="col-md-3 col-form-label label"><span class="pull-left">{{ __('(ဇ)') }}</span>{{ __('ဆက်သွယ်ရန်လိပ်စာ') }}</div>
                                    <div class="col-md-8">
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-md-3 renew_file" id="renew_file"></div>
                                    <div class="col-md-8">
                                        <input type="file"  class="form-control" name="renew_file" style="display:none">
                                    </div>
                                </div><br/>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 cpa_certificate" id="cpa_certificate"></div>
                                <div class="col-md-8">
                                    <input type="file"  class="form-control" name="cpa_certificate" style="display:none">
                                </div>
                            </div><br/><br>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 mpa_mem_card" id="mpa_mem_card"></div>
                                <div class="col-md-8">
                                    <input type="file"  class="form-control" name="mpa_mem_card" style="display:none">
                                </div>
                            </div><br><br>
                            <div class="row mb-3">
                                <div class="col-md-1"></div>
                                ...
                                <div class="col-md-4 mpa_mem_card_back" id="mpa_mem_card_back"></div>
                                <div class="col-md-8">
                                    <input type="file"  class="form-control" name="mpa_mem_card_back" style="display:none">
                                </div>
                            </div>
                          ...
                          <div class="row">
                              ...
                              <div class="col-md-4 cpd_record" id="cpd_record"></div>
                              <div class="col-md-8">
                                  <input type="file"  class="form-control" name="cpd_record" style="display:none">
                              </div>
                          </div><br/>
                          ...
                          <div class="row">
                              ...
                              <div class="col-md-6 col-form-label">ရပ်နား Form တင်ထားသည့်ခုနှစ်</div>
                              <div class="col-md-4">
                                  <input type="text" name="resign_date" id="resign_date" class="form-control">
                              </div>
                          </div><br/><br><br>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="button" style="background-color: #39c0ba" class="btn btn-sm text-white" onclick="RenewOfflineCPAFF()">Submit</button>
            </div>
          </div>
        </div>
      </div>
...
<script type="text/javascript">
    ...
    //         document.getElementById('nrc_front_img').src=BASE_URL + cpaff.nrc_front;
    //         document.getElementById('nrc_back_img').src=BASE_URL + cpaff.nrc_back;
    //     }
    // });
</script>
@endpush
