                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 text-center">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <label class="col-md-10 col-form-label"><input type="text" name="country" class="form-control" autocomplete="off" style="display: inline;width: 100px;" disabled> နိုင်ငံ <input type="text" name="government" autocomplete="off" class="form-control" style="display: inline;width: 100px;" disabled>အဖွဲ့အစည်းကပေးအပ်သည့် စာရင်းပညာဆိုင်ရာဘွဲ့/လက်မှတ်ရရှိခဲ့ပြီး မြန်မာနိုင်ငံစာရင်းကောင်စီက 
                                    <input type="text" name="exam_year" id="exam_year" placeholder="ခုနှစ်" class="form-control" autocomplete="off" style="display: inline;width: 100px;" disabled> ခုနှစ် <input type="text" name="exam_month" id="exam_month" autocomplete="off" placeholder="လ" class="form-control" style="display: inline;width: 100px;" disabled> လတွင်
                                    ကျင်းပခဲ့သည့် အရည်အချင်းစစ်စာမေးပွဲကို ခုံအမှတ်<input type="text" name="roll_no" autocomplete="off" class="form-control" style="display: inline;width: 100px;" disabled>ဖြင့် အောင်မြင်ခဲ့ပါသည်။</label>
