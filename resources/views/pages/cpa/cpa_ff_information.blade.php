...
$('#file').change(function(e) {
    ...
    // $("input[name='old_card_no_year']").flatpickr({
    //         enableTime: false,
    //         dateFormat: "M-Y",
    //         allowInput: true,
    // });
