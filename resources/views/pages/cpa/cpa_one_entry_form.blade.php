                    ...
                    <div class="form-wrapper">
                        ...
                        <div class="card border-success mb-3" style="padding:3% 5% 3% 5%;">
                            <div class="card-body">
                                ...
                                <form method="Post" action="javascript:void();" id="cpa_one_entry_form" enctype="multipart/form-data"  novalidate>
                                    @csrf
                                    <div class="col-md-12">
                                        <div class="row">
                                        <input type="hidden" id="entry_type" value="entry_form">
                                            <div class="col-md-8">
                                                ...
                                                <div class="row mb-4">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div>
                                                            <input type="password" placeholder="လျှို့ဝှက်နံပါတ်ထည့်ပါ။" name="password" id="password" class="form-control" value="{{ old('password') }}" minlength="8">
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div>
                                                            <input type="password" placeholder="လျှို့ဝှက်နံပါတ်ကို နောက်တစ်ကြိမ်ထပ်မံထည့်ပါ။" name="confirm_password" class="form-control" >
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-md-4 col-form-label label"><span class="pull-left">{{ __('၈။') }}</span>လူမျိုး</label>
                                            <div class="col-md-8">
                                                <div>
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-md-4 col-form-label label"><span class="pull-left">{{ __('၉။') }}</span>ကိုးကွယ်သည့် ဘာသာ</label>
                                            <div class="col-md-8">
                                                <div>
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-md-4 col-form-label label"><span class="pull-left">{{ __('၁၀။') }}</span>မွေးသက္ကရာဇ်</label>
                                            <div class="col-md-8">
                                                <div>
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-md-4 col-form-label label"><span class="pull-left">{{ __('၁၁။') }}</span>ဖုန်းနံပါတ်</label>
                                            <div class="col-md-8">
                                                <div>
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-md-4 col-form-label label"><span class="pull-left">{{ __('၂၁။') }}</span>နိုင်ငံ့ဝန်ထမ်း ဟုတ်/မဟုတ်</label>
                                            ...
                                            <label  class="error attend_place_error" style="display:none; padding-left: 352px;" for="gov_staff">Please select one</label>
                                        </div>
                                        ...
                                        <div class="row mb-3">
                                            <label class="col-md-4 col-form-label">
                                                <span class="pull-left" style="padding-right: 30px;">{{ __('၂၃။') }}</span>
...
@endsection
@push('scripts')
<script src="{{ asset('js/form_validation/cpa_one_entry_validation.js') }}"></script>
